...
from app.communication.input import DataInputs
...
class AppPanel(tk.Tk):
    def __init__(self):
        ...
        self.app_inputs = DataInputs(self)
        self.symptomsTrie = self.app_queries.SymptomsTrie.root
        self._initPanel()

    def _initPanel(self):
        self.frames, self.framesHash = {}, {}
        for F, strName in zip(
            ...
            self.frames[F], self.framesHash[strName] = frame, F
        self.show_frame(UserLogInPanel)
